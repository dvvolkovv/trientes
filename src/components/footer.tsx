  ...
  return (
    <footer className="mt-20 bg-bg-tint border-t border-hairline">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 xl:px-20 py-12">
        ...
        <div className="mt-12 pt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 num text-[11px] uppercase tracking-[0.18em] text-muted border-t border-hairline">
          <div>
            &copy; {year} {t("appName")}
          </div>
