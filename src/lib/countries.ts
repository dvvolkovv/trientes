// ISO-3166 alpha-2 country list used by the cabinet country select.
// Names stay in English here; the select renders them as-is — i18n can be
// added later by mapping the code in a translation file.
...
export const COUNTRIES: Country[] = [
  ...
  { code: "AW", name: "Aruba" }, { code: "AX", name: "Åland Islands" },
  ...
  { code: "BL", name: "Saint Barthélemy" }, { code: "BM", name: "Bermuda" },
  { code: "BN", name: "Brunei" }, { code: "BO", name: "Bolivia" },
  { code: "BQ", name: "Caribbean Netherlands" }, { code: "BR", name: "Brazil" },
  { code: "BS", name: "Bahamas" }, { code: "BT", name: "Bhutan" },
  { code: "BV", name: "Bouvet Island" }, { code: "BW", name: "Botswana" },
  { code: "BY", name: "Belarus" }, { code: "BZ", name: "Belize" },
  { code: "CA", name: "Canada" }, { code: "CC", name: "Cocos Islands" },
  ...
  { code: "CX", name: "Christmas Island" }, { code: "CY", name: "Cyprus" },
  ...
  { code: "EH", name: "Western Sahara" }, { code: "ER", name: "Eritrea" },
  ...
  { code: "HM", name: "Heard Island" }, { code: "HN", name: "Honduras" },
  ...
  { code: "MO", name: "Macao" }, { code: "MP", name: "Northern Mariana Islands" },
  ...
  { code: "SG", name: "Singapore" }, { code: "SH", name: "Saint Helena" },
  ...
  { code: "TO", name: "Tonga" }, { code: "TR", name: "Türkiye" },
  ...
  { code: "UM", name: "U.S. Minor Outlying Islands" }, { code: "US", name: "United States" },
  ...
  { code: "VI", name: "U.S. Virgin Islands" }, { code: "VN", name: "Vietnam" },
